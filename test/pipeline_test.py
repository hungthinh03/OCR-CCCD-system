...
cv2.imwrite("test/output_document.jpg", document_image)
...
for field_name, bbox in field_bboxes.items():
    ...
    # Save crop
    cv2.imwrite(f"test/field_outputs/output_{field_name}.jpg", crop)
...
# Save
cv2.imwrite("test/output_fields.jpg", debug_img)
